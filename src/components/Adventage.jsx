        ...
        <section className="bg-gray-800 py-3">
            ...
            <div className='flex gap-8 md:gap-20 items-center justify-center flex-wrap mt-6' >
                ...
                <div className="w-32 flex flex-col items-center text-orange-400">
                    ...
                    <span className=" text-center text-base">Concentración</span>
                </div>
