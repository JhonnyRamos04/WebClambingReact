...
export const Header = ({ Active }) => {
    ...
    return (
        <header className='text-gray-800'>
            ...
            <div>
                <div className='fixed md:hidden z-30 right-0 px-2 py-3 text-gray-100 top-0'>
                    <button onClick={handleClick} className="mgc_menu_fill text-5xl"></button>
                </div>
                <div
                    className={`fixed w-screen bg-gray-800 backdrop-blur md:hidden h-0 ${menu ? 'h-[400px]' : ''} top-0 right-0 z-[25] transition-all ease-in-out pt-4 duration-500 overflow-y-hidden`}
                >
                    <ul
