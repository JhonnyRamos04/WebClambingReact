    ...
    return (
        ...
        >
            ...
            <div className='flex flex-wrap gap-x-4 gap-y-4 md:gap-y-0 p-4'>
                <div>
                    <h1>Mejora de la resistencia</h1>
                ...
                <div>
                    <h1>Mejora de la elasticidad</h1>
                ...
                <div>
                    <h1>Mejora de la concentración</h1>
                    ...
                    emociones, desarrollarás una increíble concentración mental.
                </div>
            </div>
        </section >
    )
